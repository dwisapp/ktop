...
class WhatsAppApi:
    ...
    def _submit_template_new(self, json_data,templates_url="message_templates"):
        """
        ...
        response = self.__api_requests("POST", f"/{self.wa_account_id.account_uid}/{templates_url}",
