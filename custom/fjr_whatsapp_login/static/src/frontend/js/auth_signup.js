odoo.define("fjr_whatsapp_login.WebSignup", function (require) {
	"use strict";
	...
	var _t = core._t;
	publicWidget.registry.WhatsappWebSignup = publicWidget.Widget.extend({
		selector: "form.oe_signup_form",
		events: {
